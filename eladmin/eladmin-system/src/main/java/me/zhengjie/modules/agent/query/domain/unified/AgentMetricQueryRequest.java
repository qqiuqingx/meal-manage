...
public class AgentMetricQueryRequest {
    /** 指标枚举。 */ @NotBlank @Pattern(regexp = "CUSTOMER_PROFILE_COUNT|ACTIVE_SERVICE_CUSTOMER_COUNT|ACTIVE_ORDER_COUNT|DAILY_SCHEDULED_CUSTOMER_COUNT|DAILY_VERIFIED_CUSTOMER_COUNT|DAILY_UNVERIFIED_CUSTOMER_COUNT|DAILY_UNSCHEDULED_CUSTOMER_COUNT|MEAL_PLAN_FAILURE_COUNT|EXPIRING_ORDER_COUNT") private String metric;
