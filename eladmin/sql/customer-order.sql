...
CREATE TABLE customer_order (
    ...
    parent_package_id BIGINT NULL COMMENT '父套餐ID(关联parent_package)',
    child_package_id BIGINT NULL COMMENT '子套餐ID(关联sub_package)',
    ...
    status TINYINT NOT NULL DEFAULT 1 COMMENT '订单状态(0=已取消,1=进行中,2=已完成,3=已退餐,4=暂停)',
