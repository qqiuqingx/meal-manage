CREATE TABLE IF NOT EXISTS `agent_chat_session` (
  ...
  `order_id` bigint DEFAULT NULL COMMENT '当前会话订单ID',
  `order_code` varchar(64) DEFAULT NULL COMMENT '当前会话订单编号',
  `meal_plan_record_id` bigint DEFAULT NULL COMMENT '当前会话排餐客户记录ID',
  `record_date` varchar(20) DEFAULT NULL COMMENT '当前会话排查日期',
  `query_start_date` varchar(20) DEFAULT NULL COMMENT '当前会话受控查询起始日期',
  `query_end_date` varchar(20) DEFAULT NULL COMMENT '当前会话受控查询结束日期',
