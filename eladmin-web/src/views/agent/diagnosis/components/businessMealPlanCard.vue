<template>
  <div class="business-meal-plan-card">
    <el-table :data="items" size="mini" border>
      ...
      <el-table-column v-if="hasDeliveryAddress" prop="maskedDeliveryAddress" label="配送地址摘要" min-width="130" />
...
export default {
  ...
  computed: {
    items() { return this.result.items || [] },
    hasDeliveryAddress() { return this.items.some(item => item.maskedDeliveryAddress) }
  },
